              ...
              <div className="p-3 sm:p-4">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1.5 text-xs text-gray-500">
                  ...
                  <span className="bg-gray-100 px-1.5 py-0.5 rounded text-[10px]">
                    {result.data.originalUrl.includes('lulu') ? 'LuluStream' : result.data.originalUrl.includes('vidara') ? 'Vidara' : result.data.originalUrl.includes('firestream') ? 'FireStream' : 'MixDrop'}
                  </span>
